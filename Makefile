...
target_alias=i386-linux-gnuaout
target_vendor=pc
target_os=linux-gnuaout
target=i386-pc-linux-gnuaout

program_transform_name = s&^&i386-linux-gnuaout-&
...
TOPLEVEL_CONFIGURE_ARGUMENTS=./configure --target=i386-linux-gnuaout --prefix=/os2

tooldir = ${exec_prefix}/i386-linux-gnuaout
build_tooldir = ${exec_prefix}/i386-linux-gnuaout
...
BUILD_CONFIGARGS =  --cache-file=./config.cache '--prefix=/os2' --program-transform-name='s&^&i386-linux-gnuaout-&' --disable-option-checking --with-build-subdir="$(BUILD_SUBDIR)"
...
SUBDIRS =  intl libiberty opcodes bfd zlib binutils gas ld gprof etc
TARGET_CONFIGDIRS = 
# This is set by the configure script to the arguments to use when configuring
# directories built for the host system.
HOST_CONFIGARGS =  --cache-file=./config.cache  --with-gnu-as --with-gnu-ld '--prefix=/os2' --program-transform-name='s&^&i386-linux-gnuaout-&' --disable-option-checking
...
TARGET_SUBDIR = i386-linux-gnuaout
# This is set by the configure script to the arguments to use when configuring
# directories built for the target.
TARGET_CONFIGARGS = --cache-file=./config.cache --enable-multilib --with-cross-host=x86_64-pc-linux-gnu   '--prefix=/os2' --program-transform-name='s&^&i386-linux-gnuaout-&' --disable-option-checking --with-target-subdir="$(TARGET_SUBDIR)"
# This is the list of variables to export in the environment when
...
LEX = flex
M4 = m4
MAKEINFO = /home/jsteve/os2/binutils-2.27/missing makeinfo
EXPECT = expect
RUNTEST = runtest
...
CC_FOR_TARGET=$(STAGE_CC_WRAPPER) i386-linux-gnuaout-cc

# If GCC_FOR_TARGET is not overriden on the command line, then this
# variable is passed down to the gcc Makefile, where it is used to
# build libgcc2.a.  We define it here so that it can itself be
# overridden on the command line.
GCC_FOR_TARGET=$(STAGE_CC_WRAPPER) i386-linux-gnuaout-gcc
CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) i386-linux-gnuaout-c++
RAW_CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) i386-linux-gnuaout-c++
GCJ_FOR_TARGET=$(STAGE_CC_WRAPPER) i386-linux-gnuaout-gcj
GFORTRAN_FOR_TARGET=$(STAGE_CC_WRAPPER) i386-linux-gnuaout-gfortran
GOC_FOR_TARGET=$(STAGE_CC_WRAPPER) i386-linux-gnuaout-gccgo
DLLTOOL_FOR_TARGET=$$r/$(HOST_SUBDIR)/binutils/dlltool
LD_FOR_TARGET=$$r/$(HOST_SUBDIR)/ld/ld-new

LIPO_FOR_TARGET=i386-linux-gnuaout-lipo
